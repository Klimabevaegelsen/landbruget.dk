    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const getMapStyle = (dark)=>({
                ...
                sources: {
                    ...
                    ...Object.fromEntries(Object.entries(map.current.getStyle().sources || {}).filter(([key])=>key.includes('h3-') || key.includes('bnbo-')))
                },
                layers: [
                    // Base layers
                    ...dark ? [
                    ...
                    ...Object.values(map.current.getStyle().layers || []).filter((layer)=>layer.id.includes('h3-') || layer.id.includes('bnbo-'))
                ]
            });
...
//# sourceMappingURL=src_d3166d60._.js.map