...
export function DataSidebar({
      ...
      return (
        <div className="space-y-3">
          ...
          <div className="bg-slate-800 rounded-lg p-3 border border-slate-600">
            <h4 className="text-slate-200 font-medium mb-2 text-sm">
              Activity
            </h4>
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full w-80 bg-slate-900/95 backdrop-blur-sm border-l border-slate-700 shadow-2xl z-40 transform transition-transform duration-300 ease-in-out ${
