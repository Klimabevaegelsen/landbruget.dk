...
class PerformanceMonitor:
    ...
    def __init__(self, window_size: int = 100, alert_thresholds: Optional[Dict] = None, log_interval: int = 30):
        """
    ...
    def record_batch_metrics(
        ...
        # Calculate progress
        progress_percent = (
            (self.total_records_processed / self.total_records_target * 100) if self.total_records_target > 0 else 0
        )
    ...
    def get_optimal_batch_size(self, current_batch_size: int) -> int:
        ...
        best_performance = 0
        # best_batch_size = current_batch_size  # Unused variable
            ...
            try:
                ...
                if not self.stop_event.is_set() and self.metrics_history:
                    ...
                    self.logger.info(
                        ...
                        f"ETA: {current_metrics.eta_minutes:.1f}min"
                        if current_metrics.eta_minutes
                        else "ETA: Unknown"
                    )
    ...
    def _check_alerts(self, metrics: PerformanceMetrics):
        ...
        # Log alerts
        for alert in alerts:
            self.alerts_history.append({**alert, "timestamp": datetime.now()})
    ...
    def get_performance_report(self) -> Dict:
        ...
        report = {
            ...
            "alerts": {
                ...
                "recent_alerts": [
                    a for a in self.alerts_history if (datetime.now() - a["timestamp"]).seconds < 300
                ],  # Last 5 minutes
            },
            "optimization": {
