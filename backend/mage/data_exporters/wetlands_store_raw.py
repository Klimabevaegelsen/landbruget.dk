...
if __name__ == "__main__":
    ...
    test_data = {
        ...
        "metadata": {"total_features": 1, "num_batches": 1},
    }
    # Test with mock config
    test_config = {"storage_path": "wetlands/test_raw.jsonl"}
    result = export_data(test_data, config=test_config)
    print(
        f"Saved {result['feature_count']} features to {result['raw_data_path']} in {result['storage_mode']} mode"
    )
