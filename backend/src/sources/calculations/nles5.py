...
class NLES5Calculator:
    ...
    This implementation is based on the SAS code from the Danish Agricultural Agency's
    climate tool calculation basis. It calculates nitrogen washout for agricultural fields
    based on:
