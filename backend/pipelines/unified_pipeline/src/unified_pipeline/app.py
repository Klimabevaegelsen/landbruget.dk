...
from unified_pipeline.bronze.jordbrugsanalyser import JordbrugsanalyserBronze, JordbrugsanalyserBronzeConfig
...
from unified_pipeline.silver.jordbrugsanalyser import JordbrugsanalyserSilver, JordbrugsanalyserSilverConfig
