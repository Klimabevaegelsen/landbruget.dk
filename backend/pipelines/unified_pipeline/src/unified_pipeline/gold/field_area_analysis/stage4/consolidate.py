...
class ConsolidateResults(FieldAnalysisStageBase):
    ...
    async def _execute_stage_processing(self) -> Dict[str, Any]:
        ...
        # First, create a comprehensive field summary with property data (including fields with NULL property data)
        self.log.info("Step 1: Creating field-property summary from Stage 1C (handles NULL property data)...")
        self.conn.execute("""
            ...
            SELECT 
                ...
                -- Property ownership summary (handles NULL property data correctly)
                ...
                (
                    ...
                    AND fp2.bfe_number IS NOT NULL
