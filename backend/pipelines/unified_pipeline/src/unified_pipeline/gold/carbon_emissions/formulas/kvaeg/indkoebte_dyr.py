...
ANIMAL_TYPE_DATA = {
    ...
    "opdraet_0_6mdr_tung": {
        "default_lv_kg": 150,
        "co2e_per_kg_lv": 9.0,
    },  # Assuming LV, factor for 'kvie'
    "opdraet_0_6mdr_jersey": {
        "default_lv_kg": 100,
        "co2e_per_kg_lv": 9.0,
    },  # Assuming LV, factor for 'kvie'
    # Tyre 0-6 mdr.
    ...
    "opdraet_6mdr_kaelv_tung": {
        "default_lv_kg": 550,
        "co2e_per_kg_lv": 9.0,
    },  # Assuming LV, factor for 'kvie'
    "opdraet_6mdr_kaelv_jersey": {
        "default_lv_kg": 380,
        "co2e_per_kg_lv": 9.0,
    },  # Assuming LV, factor for 'kvie'
...
def calculate_co2e_single_purchase_group(
    ...
    lv_kg_to_use = (
        actual_average_lv_kg if actual_average_lv_kg is not None else data["default_lv_kg"]
    )

    co2e_per_animal = lv_kg_to_use * data["co2e_per_kg_lv"]
    return co2e_per_animal * number_purchased
...
if __name__ == "__main__":
    example_purchases_input = [
        ...
        {
            "animal_type_key": "tyre_6mdr_slagt_tung",
            "number_purchased": 10,
            "actual_average_lv_kg": 580,
        },
    ]
    ...
    expected_tyre_co2e = (
        ANIMAL_TYPE_DATA["tyre_0_6mdr_tung"]["default_lv_kg"]
        * ANIMAL_TYPE_DATA["tyre_0_6mdr_tung"]["co2e_per_kg_lv"]
    )
    print(
        f"Test CO2e for one default 'tyre_0_6mdr_tung' ({ANIMAL_TYPE_DATA['tyre_0_6mdr_tung']['default_lv_kg']}kg): {test_tyre_0_6_tung:.2f} kg CO2e (Expected: {expected_tyre_co2e:.2f})"
    )
