def beregn_co2e_indkoeb_slagtekyllinger(
    a_daggamle: float, theta_daggamle: float, a_rugeaeg: float, theta_rugeaeg: float, a_slagt: float
) -> float:
    """
    ...
    if a_slagt == 0:  # Prevent division by zero
        return 0.0
    return (a_daggamle * theta_daggamle + a_rugeaeg * theta_rugeaeg) / a_slagt


def beregn_co2e_indkoeb_hoenniker(
    a_konsum: float, theta_konsum: float, a_leve: float, theta_leve: float, a_hoennike_prod: float
) -> float:
    """
    ...
    if a_hoennike_prod == 0:  # Prevent division by zero
        return 0.0
    return (a_konsum * theta_konsum + a_leve * theta_leve) / a_hoennike_prod


def beregn_co2e_indkoeb_hoener(
    a_hoenniker_indkoeb: float, theta_hoenniker: float, a_hoene_prod: float
) -> float:
    """
    ...
    if a_hoene_prod == 0:  # Prevent division by zero
        return 0.0
    return (a_hoenniker_indkoeb * theta_hoenniker) / a_hoene_prod
