...
def beregn_nh3_stald_fjerkrae(
    s_nh3: float, lambda_fjer: float, v_varmeveksler_reduktion: float = 1.0
) -> float:
    """
    ...
    """
    return (s_nh3 / lambda_fjer) * v_varmeveksler_reduktion
...
def beregn_co2e_nh3_stald_fjerkrae(nh3_stald: float, theta_n2o_co2: float) -> float:
    ...
    """
    return nh3_stald * (44.0 / 28.0) * EF_N2O_GENERAL * theta_n2o_co2
...
def beregn_n2o_stald_fjerkrae_kg_n(s_n2o_kg_n_potential: float, lambda_fjer: float) -> float:
    ...
    """
    return s_n2o_kg_n_potential / lambda_fjer
...
def beregn_co2e_ch4_stald_fjerkrae(ch4_stald: float, theta_ch4_co2: float) -> float:
    ...
    """
    return ch4_stald * theta_ch4_co2
