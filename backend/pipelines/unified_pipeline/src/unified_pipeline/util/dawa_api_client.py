...
class DAWAAPIClient:
    ...
    def __init__(self):
        ...
        self.session.headers.update({
            "User-Agent": "landbrugsdata-cvr-enrichment/1.0"
        })
    ...
    def geocode_address_by_id(self, adresse_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            coordinates = data.get("adgangsadresse", {}).get("adgangspunkt", {}).get("koordinater", [])
    ...
    def geocode_addresses_batch(self, address_ids: List[str], max_concurrent: int = 5) -> Dict[str, Optional[Dict[str, Any]]]:
        """
