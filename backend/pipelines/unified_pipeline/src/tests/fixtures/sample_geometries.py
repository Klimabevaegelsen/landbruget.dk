...
def create_sample_bnbo_data(conn: duckdb.DuckDBPyConnection) -> None:
    ...
    conn.execute("""
        ...
        SELECT
            'Natura2000' as status_category,
            ST_GeomFromText(
                'MULTIPOLYGON(((10.7 56.4, 10.8 56.4, 10.8 56.5, 10.7 56.5, 10.7 56.4)))'
            ) as geometry
        UNION ALL
        SELECT
            'Protected' as status_category,
            ST_GeomFromText(
                'MULTIPOLYGON(((11.5 55.5, 11.6 55.5, 11.6 55.6, 11.5 55.6, 11.5 55.5)))'
            ) as geometry
    """)
...
def create_sample_wetlands_data(conn: duckdb.DuckDBPyConnection) -> None:
    ...
    conn.execute("""
        ...
        SELECT
            ...
            ST_GeomFromText(
                'POLYGON((12.4 55.4, 12.5 55.4, 12.5 55.5, 12.4 55.5, 12.4 55.4))'
            ) as geometry
        UNION ALL
        SELECT
            'WETLAND_002' as id,
            'Bog' as wetland_type,
            ST_GeomFromText(
                'POLYGON((10.9 56.6, 11.0 56.6, 11.0 56.7, 10.9 56.7, 10.9 56.6))'
            ) as geometry
    """)
...
def create_sample_soil_types_data(conn: duckdb.DuckDBPyConnection) -> None:
    ...
    conn.execute("""
        ...
        SELECT
            ...
            ST_GeomFromText(
                'POLYGON((12.6 55.6, 12.7 55.6, 12.7 55.7, 12.6 55.7, 12.6 55.6))'
            ) as geometry
        UNION ALL
        SELECT
            'SAND' as soil_type,
            ...
            ST_GeomFromText(
                'POLYGON((11.1 56.8, 11.2 56.8, 11.2 56.9, 11.1 56.9, 11.1 56.8))'
            ) as geometry
    """)
...
def create_sample_properties_data(conn: duckdb.DuckDBPyConnection) -> None:
    ...
    conn.execute("""
        ...
        SELECT
            ...
            ST_GeomFromText(
                'POLYGON((12.8 55.8, 12.9 55.8, 12.9 55.9, 12.8 55.9, 12.8 55.8))'
            ) as geometry
        UNION ALL
        SELECT
            ...
            ST_GeomFromText(
                'POLYGON((11.3 57.0, 11.4 57.0, 11.4 57.1, 11.3 57.1, 11.3 57.0))'
            ) as geometry
    """)
...
def create_sample_water_projects_data(conn: duckdb.DuckDBPyConnection) -> None:
    ...
    conn.execute("""
        ...
        SELECT
            ...
            ST_GeomFromText(
                'POLYGON((13.0 56.0, 13.1 56.0, 13.1 56.1, 13.0 56.1, 13.0 56.0))'
            ) as geometry
        UNION ALL
        SELECT
            'WP002' as project_id,
            ...
            ST_GeomFromText(
                'POLYGON((11.5 57.2, 11.6 57.2, 11.6 57.3, 11.5 57.3, 11.5 57.2))'
            ) as geometry
    """)
