...
The Field Area Analysis Pipeline analyzes 600K+ agricultural fields against:
...
- `year`: Analysis year (default: "latest" - auto-discovers most recent)
- `batch_size`: Fields per batch (default: 1000)
- `max_batches`: Maximum batches to process (0 for all fields)
