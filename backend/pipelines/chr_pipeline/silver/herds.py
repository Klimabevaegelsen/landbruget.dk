...
def create_herd_owners_table(
    ...
    try:
        ...
        herd_owners = herd_owners.mutate(
            ...
            owner_municipality_name=herd_owners.owner_municipality_name_raw.cast(dt.string)
            .strip()
            .nullif(""),
            ...
            owner_address_protection=herd_owners.owner_address_protection_raw.cast(dt.string)
            .strip()
            .nullif(""),
...
def create_herd_users_table(
    ...
    try:
        ...
        herd_users = herd_users.mutate(
            ...
            user_address_protection=herd_users.user_address_protection_raw.cast(dt.string)
            .strip()
            .nullif(""),
            user_advertising_protection=herd_users.user_advertising_protection_raw.cast(dt.string)
            .strip()
            .nullif(""),
        )
