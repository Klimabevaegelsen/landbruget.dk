...
def parse_args() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description="Export pipeline configuration to a JSON file")

    # Required output file
    parser.add_argument(
        "--output", type=str, required=True, help="Path to the output JSON configuration file"
    )
...
def include_environment_settings(config: dict) -> dict:
    ...
    env_vars = ["GOOGLE_DRIVE_FOLDER_ID", "MAX_WORKERS", "LOG_LEVEL"]
