...
class ColumnSchema(BaseModel):
    ...
    pattern: str | None = Field(None, description="Regex pattern for validation (for string type)")

    # Transformations
    transform: str | None = Field(None, description="Transformation expression to apply")
    source_column: str | None = Field(None, description="Source column name if different")
    default_value: Any | None = Field(None, description="Default value for missing data")

    # Geospatial properties
    srid: int | None = Field(None, description="Spatial reference ID (for geometry type)")
...
class TableSchema(BaseModel):
    ...
    partition_by: list[str] | None = Field(None, description="List of columns to partition by")
    primary_key: str | list[str] | None = Field(None, description="Primary key column(s)")
    source_type: str | None = Field(None, description="Source file type (PDF, Excel, etc.)")
