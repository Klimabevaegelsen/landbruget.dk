...
class GKEATransformer:
    ...
    def calculate_n2o_emissions(fertilizer_summary: FertilizerSummary) -> float:
        ...
        # N2O global warming potential (GWP): 298 kg CO2e per kg N2O
        gwp_n2o = 298
...
class IntegratedFarmTransformer:
    ...
    def transform_all(
        ...
        Example:
            ...
            >>>
            >>> farm_data = IntegratedFarmTransformer.transform_all(livestock, fields, fert)
            >>> print(farm_data['metadata'])
            {'has_livestock': True, 'has_fields': True, 'has_fertilizer': True, 'total_area_ha': 125.5}
        """
