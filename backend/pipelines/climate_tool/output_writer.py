...
class ClimateOutputWriter:
    ...
    - Writes to GCS gold/climate_emissions/<timestamp>/
    ...
    def write_to_gold_layer(
        ...
        # Build output path
        output_dir = f"gs://{self.bucket}/gold/climate_emissions/{timestamp}"
    ...
    def list_available_reports(self, pattern: str = None) -> List[str]:
        ...
        try:
            if pattern:
                search_pattern = f"gs://{self.bucket}/gold/climate_emissions/{pattern}/metadata.json"
            else:
                search_pattern = f"gs://{self.bucket}/gold/climate_emissions/*/metadata.json"
    ...
    def read_report_metadata(self, report_path: str) -> Optional[Dict[str, Any]]:
        ...
        Args:
            report_path: GCS path to report directory (e.g., gs://bucket/gold/climate_emissions/20240101_120000)
        ...
        Example:
            >>> writer = ClimateOutputWriter()
            >>> metadata = writer.read_report_metadata("gs://bucket/gold/climate_emissions/20240101_120000")
