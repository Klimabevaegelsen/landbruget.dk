...
class H3PMTilesGenerator:
    ...
    def _create_kommune_geojson(self, results_table: str, year: int | str) -> str | None:
        ...
        try:
            ...
            # Check if kommune_boundaries table exists first
            ...
            try:
                ...
                has_kommune_boundaries = False
                self.log.warning(f"⚠️ {kommune_boundaries_table} table not accessible: {e}")
                self.log.info("📍 Falling back to centroids as point geometries")
                ...
                COPY (
                    SELECT 
                        ...
                        json_object(
                            ...
                            'diquat_grams', ROUND(COALESCE(r.total_diquat_containing_active_ingredient_grams, 0), 3),
                            'glyphosate_grams', ROUND(COALESCE(r.total_glyphosate_containing_active_ingredient_grams, 0), 3),
                            ...
                            'diquat_intensity', ROUND(COALESCE(r.diquat_containing_active_ingredient_intensity_grams_per_ha, 0), 3),
                            'glyphosate_intensity', ROUND(COALESCE(r.glyphosate_containing_active_ingredient_intensity_grams_per_ha, 0), 3),
                            ...
                            'diquat_applications', COALESCE(r.diquat_containing_applications, 0),
