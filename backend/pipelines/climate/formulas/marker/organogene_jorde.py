...
def calculate_co2_organogene_jorde(
    ...
    if co2_kulstof_emission_factors is None or ch4_co2e_factor_hoj_vandstand is None:
        print(
            "Warning: Table data for organogene jorde not fully loaded. Falling back to hardcoded values where necessary."
        )
    ...
    if i_omdrift and lav_vandstand:
        ...
        co2_tons_ch4 = h * (
            ...
            if not fallback_to_hardcoded and ch4_co2e_factor_hoj_vandstand is not None
            else 6.8
        )  # Loaded (should be 6.8)
    else:
...
if __name__ == "__main__":
    ...
    print(
        f"Test 1 (i omdrift, lav vand, 6-12% C): Kulstof={kulstof1:.2f}t, N2O={n2o1:.2f}t, CH4={ch41:.2f}t, Total={total1:.2f}t CO2e"
    )
    ...
    print(
        f"Test 2 (i omdrift, lav vand, >12% C): Kulstof={kulstof2:.2f}t, N2O={n2o2:.2f}t, CH4={ch42:.2f}t, Total={total2:.2f}t CO2e"
    )
    ...
    print(
        f"Test 3 (ikke omdrift, lav vand, >12% C): Kulstof={kulstof3:.2f}t, N2O={n2o3:.2f}t, CH4={ch43:.2f}t, Total={total3:.2f}t CO2e"
    )
    ...
    print(
        f"Test 4 (ikke omdrift, lav vand, 6-12% C): Kulstof={kulstof4:.2f}t, N2O={n2o4:.2f}t, CH4={ch44:.2f}t, Total={total4:.2f}t CO2e"
    )
    ...
    print(
        f"Test 5a (ikke omdrift, høj vand, 6-12% C): Kulstof={kulstof5a:.2f}t, N2O={n2o5a:.2f}t, CH4={ch45a:.2f}t, Total={total5a:.2f}t CO2e"
    )
    ...
    print(
        f"Test 5b (ikke omdrift, høj vand, >12% C): Kulstof={kulstof5b:.2f}t, N2O={n2o5b:.2f}t, CH4={ch45b:.2f}t, Total={total5b:.2f}t CO2e"
    )
    # Expected total: 10 * 6.8 (CH4) = 68.0
    ...
    try:
        ...
        print(
            f"  Result: Kulstof={kulstof_undef:.2f}t, N2O={n2o_undef:.2f}t, CH4={ch4_undef:.2f}t, Total={total_undef:.2f}t CO2e (Should be 0 or error based on current logic)"
        )
