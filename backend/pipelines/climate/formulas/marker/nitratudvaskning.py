...
# IPCC AR6 (2021) GWP for N2O - Most recent science
...
if __name__ == "__main__":
    ...
    print("\nNote: GWP values updated to IPCC AR6 (2021).")
    print("This implementation uses theta_N2O_CO2 = 273.0 (IPCC AR6).")
    print("AR4 uses 298. Difference is ~8% (intentional update).")
