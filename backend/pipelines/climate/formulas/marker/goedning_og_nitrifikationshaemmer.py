...
def calculate_n2o_components(
    ...
    n2o_nh3_kg = n_total_on_areal_kg * ef_nh3 * EF_N2O_GENERAL * MOL_WEIGHT_FACTOR_N2O_N
...
if __name__ == "__main__":
    ...
    n2o_handel_w_nitri, co2e_handel_w_nitri = calculate_n2o_goedning(
        ...
        n_nitri_kg_ha=N_nitri_handel_kg_ha,
    )
    ...
    print(
        f"  N2O: {n2o_handel_unknown_fallback:.4f} kg (Should be same as default EF_NH3 test: {n2o_handel_no_nitri:.4f})"
    )
    ...
    n2o_husdyr_w_nitri, co2e_husdyr_w_nitri = calculate_n2o_goedning(
        ...
        n_nitri_kg_ha=N_nitri_husdyr_kg_ha,
    )
    ...
    n2o_h_t4, co2e_h_t4 = calculate_n2o_goedning(
        n_total_kg_ha=N_total_handel_kg_ha_t4,
        areal_ha=AREAL_HA_TEST_t4,
        goedningstype="handelsgoedning",
        n_nitri_kg_ha=N_nitri_handel_kg_ha_t4,
    )
    ...
    print(
        f"Handelsgødning ({urea_type}, {AREAL_HA_TEST_t4} ha, {N_total_handel_kg_ha_t4} N/ha, med {nitri_percentage_handel_t4:.1f}% N m. nitrihæmmer):"
    )
    ...
    n2o_hus_t5, co2e_hus_t5 = calculate_n2o_goedning(
        n_total_kg_ha=N_total_husdyr_kg_ha_t5,
        areal_ha=AREAL_HA_TEST_t5,
        goedningstype="husdyrgoedning",
        n_nitri_kg_ha=0,
    )
