...
def main():
    ...
    parser.add_argument("--generate-sample-data", action="store_true", 
                       help="Generate sample BMD data for testing")
    parser.add_argument("--cleanup", action="store_true",
                       help="Clean up test database after completion")
    parser.add_argument("--lakehouse-path", default="bmd_lakehouse",
                       help="Path for the lakehouse database")
