...
export const metadata: Metadata = {
  ...
  description: "Læs vores brugsvilkår for Landbruget.dk - et almennyttigt, open-source og non-profit initiativ drevet af Klimabevægelsen.",
};

async function getTermsContent() {
  const termsPath = path.join(process.cwd(), "src", "content", "terms-of-use.md");
