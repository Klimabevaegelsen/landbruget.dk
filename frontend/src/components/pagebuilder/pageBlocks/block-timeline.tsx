        ...
        <div className="mb-8 flex flex-wrap gap-2">
          {Object.entries(eventTypes).map(([type, color]) => (
            <Button
              ...
              className={`flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-colors ${selectedTypes.has(type) ? 'text-white' : 'text-gray-600 hover:bg-gray-100'}`}
              style={{
