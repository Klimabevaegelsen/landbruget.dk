    ...
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => setConfig({ ...config, h3_resolutions: value })}
          >
            <SelectTrigger>
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => setConfig({ ...config, memory_limit: value })}
          >
            <SelectTrigger>
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => setConfig({ ...config, thread_count: value })}
          >
            <SelectTrigger>
      ...
      <div className="bg-gray-50 p-4 rounded-lg mb-6">
        ...
        <div className="text-sm space-y-1">
          ...
          <div>
            <strong>Resources:</strong> {config.memory_limit} memory, {config.thread_count} threads
          </div>
          <div>
      ...
      {/* Trigger Button */}
      <Button onClick={triggerPipeline} disabled={isLoading} className="w-full" size="lg">
        {isLoading ? (
          <>
      ...
      <div className="mt-4 text-sm text-gray-600">
        <p>
          <strong>Note:</strong> This will trigger the optimized pipeline that processes all
          resolutions in a single job to avoid redundant data downloads.
        </p>
        <p>
          <strong>Processing time:</strong> ~10-20 minutes depending on years selected.
        </p>
      </div>
    </div>
  );
