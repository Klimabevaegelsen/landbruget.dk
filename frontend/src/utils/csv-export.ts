...
export function convertToCSV(fields: FieldAnalysisData[]): string {
  ...
  const rows = fields.map((field) => [
    ...
    field.applications_kg?.toString() || '',
    field.applications_liters?.toString() || '',
    field.applications_grams?.toString() || '',
    field.applications_ml?.toString() || '',
    field.applications_tablets?.toString() || '',
    ...
    field.bnbo_area_hectares?.toString() || '',
    field.wetland_area_hectares?.toString() || '',
