...
export function convertToCSV(fields: FieldAnalysisData[]): string {
  ...
  const headers = [
    ...
    'Total Pesticidallokeringer',
    'PFAS Aktivstof (kg)',
    'PFAS Belastning',
    'PFAS Allokeringer',
    'Samlet Dosering (kg/ha)',
    'Samlet Dosering (L/ha)',
    'Samlet Dosering (g/ha)',
    'Samlet Dosering (ml/ha)',
    'Samlet Dosering (tabletter/ha)',
    'Diquat Belastning',
    'Diquat Allokeringer',
    'Glyphosate Aktivstof (kg)',
    'Glyphosate Belastning',
    'Glyphosate Allokeringer',
    'BNBO Areal (ha)',
    'Vådområde Areal (ha)',
    ...
    'Pesticide Detaljer (L/ha)',
    'Pesticide Detaljer (g/ha)',
    'Pesticide Detaljer (ml/ha)',
    'Pesticide Detaljer (tabletter/ha)',
    'Koordinater (lat)',
    'Koordinater (lng)',
  ];
